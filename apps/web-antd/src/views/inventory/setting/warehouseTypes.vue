    ...
    <div class="content-wrapper a-base-container">
        <div class="big-main-wrapper warehouse-type-wrapper" style="margin:2px 8px;">
            ...
            <div class="content-tree-wrapper">
                <div class="tree-box not-copy" style="height:99%;padding-top:10px;">
...
import editModel from "./model/warehouseTypesEdit";
    ...
    methods: {
        ...
        remove() {
            ...
            this.$confirm({
                ...
                content: "",
                onOk() {
                    postAction("/in/rdStyle/delete", [that.selectedRows.node.dataRef.id]).then(res => {
                        if (res.code == 200) {
                            that.selectedKeys = [];
