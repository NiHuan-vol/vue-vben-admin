 ...
 * @LastEditors: GW
 * @LastEditTime: 2021-12-20 09:57:45
-->
<template>
...
import { save, examine, remove, getCode, allot, approval, submitOrder } from '@/api/inventory/transfers';
...
export default {
    ...
    methods: {
        ...
        approvalClick (type) {
            ...
            approval(requestData).then((response) => {
                if (response.code === 200) {
                    const backData = response.data;
                    if (type == 2) {
