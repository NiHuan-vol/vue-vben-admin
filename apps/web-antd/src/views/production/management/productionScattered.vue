      ...
      <section>
        ...
        <a-form :layout="formLayout">
          <a-row class="order-dynamic-form-wrapper">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" :xxl="8">
              <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="派工单号">
                <a-input v-model="searchData.voucherCode" />
              </a-form-item>
            </a-col>
            <a-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" :xxl="8">
...
const fromStyle = reactive({ paddingTop: '8px' });
const labelCol = ref({ span: 8 });
const wrapperCol = ref({ span: 14 });
const editFalse = reactive({ borderBottom: '1px solid #ded7d7' });
...
const voucherTitle = ref('生产零星领料单');
...
const columnsChoiceHeader = ref<any[]>([
  ...
  {
    title: '派工数量',
    dataIndex: 'dispatchInventoryQuantity',
  },
  {
    title: '预计完工日期',
