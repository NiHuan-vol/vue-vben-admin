 ...
 * @LastEditors: GW
 * @LastEditTime: 2021-09-27 16:54:47
-->
<template>
    <div class="content-wrapper a-base-container">
        <div class="requisition-set-wrapper">
            ...
            <div class="btn-wrapper clearfix">
                <a-row class="text-center clearfix">
                    <a-col :xs="24" :sm="24" :md="24" :lg="16" :xl="12">
                        <!-- <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundSelf:audit')">
                        ...
                        <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundSelf:accounting')">
                        ...
                        <!-- <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundSelf:export')">
            ...
            <div ref="print" class="documents-wrapper" id="documents-wrapper">
                <h3 class="text-center">自制出库核算</h3>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            this.visible = false;
            let request = {
                dataSource: 'SaleDispatchVoucher',
        ...
        handlerAccounting() {
            ...
            outproductAccountingApi(this.dataSource).then(res => {
                if (res.code === 200) {
