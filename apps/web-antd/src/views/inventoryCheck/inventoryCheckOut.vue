 ...
 * @LastEditors: GW
 * @LastEditTime: 2021-09-27 16:53:06
-->
<template>
    <div class="content-wrapper a-base-container">
        <div class="requisition-set-wrapper">
            ...
            <div class="btn-wrapper clearfix">
                <a-row class="text-center clearfix">
                    <a-col :xs="24" :sm="24" :md="24" :lg="16" :xl="12">
                        <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('InventoryCheckOut:audit')">
                        ...
                        <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('InventoryCheckOut:accounting')">
            ...
            <div ref="print" class="documents-wrapper" id="documents-wrapper">
                <h3 class="text-center">采购入库核算</h3>
...
export default {
    ...
    data() {
        return {
            ...
            dataSource: [],
            showColumns: [],
            type: 1,//type:1 外购入库核算 type:2 存货暂估入库 type:3 产成品入库核算
            isRouterAlive: true,
            loading: false,
        }
    },
    ...
    methods: {
        ...
        initColumns() {
            ...
            if (this.showColumns.length > 0) {
                checkOutColumnsJson.forEach(item => {
