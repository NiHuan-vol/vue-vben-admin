 ...
 * @LastEditors: GW
 * @LastEditTime: 2021-12-29 17:39:44
-->
<template>
    <div class="content-wrapper a-base-container">
        <div class="requisition-set-wrapper">
            ...
            <div class="btn-wrapper clearfix">
                <a-row class="text-center clearfix">
                    <a-col :xs="24" :sm="24" :md="24" :lg="16" :xl="12">
                        <!-- <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundMaterials:audit')">
                        ...
                        <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundMaterials:accounting')">
                        ...
                        <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2">
                            <div class="btns" style="display:block;margin-left:10px" @click="shwoModel">
                                <a class="ant-dropdown-link">
                        ...
                        <!-- <a-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2" v-if="permissions.includes('OutboundMaterials:export')">
            ...
            <div ref="print" class="documents-wrapper" id="documents-wrapper">
                <h3 class="text-center">材料出库核算</h3>
        ...
        <!--查询-->
        <a-modal v-model="visible" title="查询" @cancel="()=>{visible = false}">
            <a-form-model :label-col="8" :wrapper-col="16" :layout="'inline'">
                <a-form-model-item label="会计期间" :rules="[{ required: true,trigger:'input'}]">
                    <a-select placeholder="请选择会计期间" v-model="periodTime" style="width:240px">
                        <a-select-option v-for="item in periodData" :key="item" :value="item.currentPeriod">
...
import {
    ...
    outInventoryListApi,
    outInventoryAccountingApi,
    outproductAccountingApi,
...
import { outInventoryColumnsJson, outSelfColumnsJson } from './columnsJson/checkOut'
export default {
    components: {
        editableCell,
        drawer
    ...
    methods: {
        ...
        getList() {
            ...
            this.visible = false;
            let request = {
                dataSource: 'MaterialDispatchVoucher',
                accountPeriod: this.periodTime,
            }
            this.loading = true;
            outInventoryListApi(request).then(res => {
                if (res.code === 200) {
        ...
        initColumns() {
            ...
            if (this.showColumns.length > 0) {
                outInventoryColumnsJson.forEach(item => {
        ...
        handlerAccounting() {
            ...
            outInventoryAccountingApi(this.dataSource).then(res => {
                if (res.code === 200) {
