 ...
 * @LastEditors: GW
 * @LastEditTime: 2021-09-27 16:55:32
-->
<template>
        ...
        <div class="requisition-set-wrapper">
            ...
            <div class="btn-wrapper clearfix">
                <a-row class="text-center clearfix">
                    ...
                    <!-- <a-col :xs="24" :sm="24" :md="24" :lg="16" :xl="12">
                        <a-col :offset="22" :xs="2" :sm="2" :md="2" :lg="2" :xl="2">
                            <div class="btns" style="display:block;margin-left:10px" @click="showDrawer">
                                <a class="ant-dropdown-link">
                                    <a-icon class="btns-icon" type="setting" />
                                    <div class="btns-text">字段设置</div>
            ...
            <div ref="print" class="documents-wrapper" id="documents-wrapper">
                <h3 class="text-center">其他入库核算</h3>
...
export default {
    ...
    data() {
        return {
            ...
            dataSource: [],
            showColumns: [],
            type: 5,//type:1 外购入库核算 type:2 存货暂估入库 type:3 产成品入库核算 type:4 委外加工入库核算 type:5 其他入库核算
            isRouterAlive: true,
            loading: false,
        }
    },
    ...
    methods: {
        ...
        getList() {
            let request = {
                dataSource: 'OtherReceiveVoucher',
            }
            this.loading = true;
